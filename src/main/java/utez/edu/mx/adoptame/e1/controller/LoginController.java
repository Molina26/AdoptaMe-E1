...
public class LoginController {
    ...
    public LoginController(InfoMovement infoMovement, RolServiceImpl rolService, UserAdoptameServiceImpl userAdoptameService){
    ...
    public String login(@RequestParam(value = "error", required = false) String error,
        ...
        List<Rol> listRol =  rolService.findAllRol();
