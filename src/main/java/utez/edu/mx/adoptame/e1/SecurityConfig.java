...
import utez.edu.mx.adoptame.e1.service.JpaUserDetailService;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                .antMatchers("/css/**", "/js/**", "/uploads/**", "/", "/index", "/user/register", "/icons/**","/user/createAccount", "/images/**", "/blog/general", "/blog/find_details_blog/{id}/{flag}", "/create-acount","/pets/adopt/{type}", "/pets/adopt", "/adoptions/detail/{id}", "/pets/filter", "/pets/add-favorite/{id}")
                .permitAll()
